    ...
    <section id="about" className="py-24 px-8 bg-white">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 w-full relative reveal from-left">
          ...
          <div className="absolute -top-6 -left-6 w-full h-full rounded-[40px] bg-primary/10 z-0" />
          <div className="relative z-10 rounded-[36px] overflow-hidden shadow-2xl aspect-[4/5] w-full max-w-md">
            <img
              src={aboutimg}
            ...
            />
            {/* Floating stat badge */}
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-md rounded-2xl px-8 py-4 shadow-xl flex items-center gap-8 w-[calc(100%-48px)]">
        ...
        <div className="flex-1 space-y-8 reveal from-right">
          <div className="inline-flex items-center gap-2 bg-primary/10 rounded-full px-4 py-1.5 text-xs font-bold tracking-widest uppercase text-primary">
            About Our School
          </div>
          ...
          <div className="flex items-center gap-4 pt-4">
            <a
              href="#about-more"
              className="bg-primary hover:bg-blue-700 text-white px-7 py-3.5 rounded-full font-bold transition-colors flex items-center gap-2 shadow-md shadow-blue-900/20"
            >
